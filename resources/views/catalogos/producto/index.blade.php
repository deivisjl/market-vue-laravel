        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                  ...
                  <div class="card-tools">
                      <a href="{{ route('productos.create') }}" class="btn btn-primary btn-xs btn-flat" style="float:right; color:#fff">Nuevo registro</a>
                  </div>
            </div>
            <div class="card-body">
    ...
    var  listar = function(){
        var table = $("#listar").DataTable({
          ...
          "columns":[
              ...
              {'data': 'nombre'},
              {'data': 'categoria'},
              {'data': 'porcentaje_ganancia', "render":function(data, type,row,meta){
                    return '<span>'+ row.porcentaje_ganancia +'%</span>'
                }
              },
              {'data': 'stock_minimo'},
