        ...
        <div class="row mb-2 justify-content-center">
            <div class="col-sm-6">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ url('unidades-de-medida', [$unidad->id]) }}" method="POST" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('cantidad') is-invalid @enderror" name="cantidad" value="{{ $unidad->cantidad }}">
                                @error('cantidad')
                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
