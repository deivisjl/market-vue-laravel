        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                  ...
                  <div class="card-tools">
                      <a href="{{ route('unidades-de-medida.create') }}" class="btn btn-primary btn-xs btn-flat" style="float:right; color:#fff">Nuevo registro</a>
                  </div>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    ...
    var obtener_data_editar = function(tbody,table){
         $(tbody).on("click","a.editar",function(e){
            ...
            var id = data.id;
             window.location.href = "/unidades-de-medida/" + id + "/edit";
          });
            ...
            var id = data.id;
             Swal.fire({
                  ...
                  cancelButtonText: 'Cancelar'
                   ...
                   if (result.value) {
                      axios.delete('/unidades-de-medida/'+id)
                          .then(response => {
